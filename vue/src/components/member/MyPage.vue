        ...
        <div class="pull-left rt size" >
           <fieldset style=" margin-top: 1%; height: 31.5%;border: 2px solid black;">
             <legend><h3>비밀번호 변경</h3></legend>
                <input type="text" name="passwd" size="20" placeholder="기존 비밀번호 입력" style="float: none; width: 70%;">
                <button style="height: 38%; width: 20%; float: right;">수정</button><br/><br/>
           <span><input type="text" name="passwd" size="20" placeholder="변경할 비밀번호 입력" style="float: none;width: 70%;"></span>
           </fieldset>
           <fieldset style="margin-top: 1%; height: 31.5%;border: 2px solid black;">
